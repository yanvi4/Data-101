...
dim(loan_complete)
tail(loan_complete, 6)
```

## Organizing the Data

We are looking at the first few columns in order to get a better feel for the data. Besides, the column of funded_amnt will be removed because the value for funded_amnt is same as the value of loan_amnt. Removing other columns
